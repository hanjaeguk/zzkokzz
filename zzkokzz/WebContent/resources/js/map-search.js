        ...
        (function(smarker, title) {
            ...
            itemEl.onmousedown = function () {
            	...
            	if (result) {
           		...
           		// document.getElementById("locPosition").value = smarker.getPosition();
              	// document.getElementById("locLat").value = smarker.getPosition().getLat();
              	// document.getElementById("locLng").value = smarker.getPosition().getLng();
              	 document.getElementById("localTitle").value = title;
              	// document.getElementById("locAdress").value = document.getElementById("roadAddress"+(smarker.getZIndex()+1)).innerHTML
              	// document.getElementById("locRoadAdress").value = document.getElementById("jibunAddress"+(smarker.getZIndex()+1)).innerHTML
            	}		
           	};
